...
def parse_args():
    ...
    p.add_argument('--home', required=False, default='New York Knicks')
    p.add_argument('--away', required=False, default='Miami Heat')
    p.add_argument('--home-odds', type=float, required=False, default=1.53)
    p.add_argument('--away-odds', type=float, required=False, default=4.50)
    p.add_argument('--home-spread', type=float, required=False, default=None)
    p.add_argument('--away-spread', type=float, required=False, default=None)
    p.add_argument('--home-water', type=float, required=False, default=None, help='Asian water / payout multiplier, e.g. 0.98')
    p.add_argument('--away-water', type=float, required=False, default=None)
    p.add_argument('--home-injuries', type=str, required=False, default='')
    p.add_argument('--away-injuries', type=str, required=False, default='')
    return p.parse_args()
